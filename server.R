...
#------------------------------------------------------------------ SETTING UP API -------------------------------------------------------------------------------------------------
  ...
  consumer_api_key <- "pF6jJOA6KoRBv0tUCIFj19paV" # Enter your consumer key
  consumer_api_secret <- "J5vBn9nR8YcJ9RO16QqvqggZsEtAYE4mOxUJj3zVh1AxIDmu5K" # Enter your consumer secret
  access_token <- "3240224891-55E1niP04NGGTsGQ2a1PeRmop2FuTx4gKMVO5vU" # Enter your access token
  access_token_secret <- "Ou1ZmoCs7RdCOYgDQTN6s26Tq8Oz2TL1v6jXIZRrJ3C4O" # Enter your access secret
...
#------------------------------------------------------------------------- TABLE DATA -----------------------------------------------------------------------------------------------	
  ...
  library(plotrix)
  output$piechart <- renderPlot({ pie3D(slices(), labels = labels, col=c("green","red"),explode=0.00, main="Sentiment Analysis") })
